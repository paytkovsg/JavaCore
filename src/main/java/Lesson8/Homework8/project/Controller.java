...
public class Controller {
    ...
    DatabaseRepository databaseRepository = new AccuWeatherProvider();
    ...
    public Controller() {
        ...
        variantResult.put(3, Functionality.GET_CURRENT_WEATHER_DB);
    ...
    public void getCurrentWeatherToDB() throws IOException, SQLException {
        databaseRepository.getWeatherBase(Periods.NOW);
